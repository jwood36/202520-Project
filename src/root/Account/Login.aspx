<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="coding_lms.Account.Login" Async="true" %>
        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="row">
                    ...
                    <div class="row">
                        <asp:Label runat="server" AssociatedControlID="txtQuiz" CssClass="col-md-2 col-form-label">Quiz ID</asp:Label>
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="txtQuiz" TextMode="Password" CssClass="form-control" />
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtQuiz" CssClass="text-danger" ErrorMessage="The password field is required." />
                        </div>
                    </div>
                    <div class="row">
